...
from PySide2.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, 
                               ...
                               QRadioButton, QButtonGroup, QSpinBox, QListWidget, QProgressBar, QGridLayout)
...
class LanTransferUltimateProApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("局域网文件/文件夹对传工具 (精简美化版)")
    ...
    def init_ui(self):
        ...
        server_layout.setRowStretch(4, 1) # 留白下沉
